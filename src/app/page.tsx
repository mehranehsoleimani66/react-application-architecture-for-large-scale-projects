...
import { Placeholder } from "./_components/placeholder/card-placeholder";
import { TestimonialList } from "./_components/testimonal/testimonial-list";
import { BlogPostSummary } from "./_components/types/blogs-summery.interface";
  ...
  return (
    <>
      ...
      <section className="container  pt-20">
        ...
        <Suspense fallback={<Placeholder count={4} className="mt-5" />}>
